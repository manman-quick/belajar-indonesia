...
const initialState: LearningState = {
  ...
  lessonProgress: {},
  unitProgress: {
    "unit-1": { unitId: "unit-1", lessonsCompleted: 0, totalLessons: 6, unlocked: true },
    "unit-2": { unitId: "unit-2", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-3": { unitId: "unit-3", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-4": { unitId: "unit-4", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-5": { unitId: "unit-5", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-6": { unitId: "unit-6", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-7": { unitId: "unit-7", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-8": { unitId: "unit-8", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-9": { unitId: "unit-9", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
    "unit-10": { unitId: "unit-10", lessonsCompleted: 0, totalLessons: 5, unlocked: false },
  },
  favoriteVocabulary: [],
};
